...
std::wstring Requests[] = {
    L"https://fapi.binance.com/fapi/v1/ticker/bookTicker",
        L"https://fapi.binance.com/fapi/v1/time",
        L"https://fapi.binance.com/fapi/v1/depth?symbol=EGLDUSDT&limit=500",
        L"https://fapi.binance.com/fapi/v1/depth?symbol=SOLUSDT&limit=500",
        L"https://fapi.binance.com/fapi/v1/klines?symbol=KSMUSDT&interval=5m",
        L"https://fapi.binance.com/fapi/v1/klines?symbol=SOLUSDT&interval=5m"
};
...
int main()
{
    ...
    doNextRequest(L"google.com");

    while (!Terminated) {
        for (std::wstring s : Requests) { doNextRequest(s);}
        Sleep(500);
    }
